...
public class Win extends javax.swing.JFrame {
    ...
    public Win() {
        initComponents();
        username.setText("Ganaste!!, " + LoggedUser.Nsesion + " felicidades!!");
    }
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(40, 360, 200, 40);

        username.setFont(new java.awt.Font("Segoe UI Light", 0, 24)); // NOI18N
        username.setForeground(new java.awt.Color(255, 255, 255));
        getContentPane().add(username);
        username.setBounds(40, 320, 390, 30);

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/grupo11/recursos/Ganador.png"))); // NOI18N
