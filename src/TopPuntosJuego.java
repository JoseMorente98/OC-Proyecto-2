 ...
 * @author Javier C
 */
public class TopPuntosJuego extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("TOP 10 Puntos");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(100, 50, 900, 150);
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/grupo11/recursos/Listas.png"))); // NOI18N
        ...
        try {
            ...
            Collections.sort(LoggedUser.puntos, new Comparator<Results>() {
                ...
                public int compare(Results o1, Results o2) {
                    return new Integer(o2.getPoints()).compareTo(new Integer(o1.getPoints()));
                }
            });
    ...
    private void printArrayListResults() {
        ...
        File f;
        f = new File("C:\\ProyectoOrga\\puntos.rep");
        try {
